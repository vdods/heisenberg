...
class OptionParser:
    def __init__ (self, *, prog_name):
        ...
        self.op.add_option(
            ...
            default='.',
            type='str',
            help='Specify the directory that sample_v.*.pickle files will be written to or read from (see options --sample and --plot-samples).'
        )
        self.op.add_option(
            '--plot-samples',
            dest='plot_samples',
            action='store_true',
            default=False,
            help='Read data in from all sample_v.*.pickle files from the current directory (as generated by the --sample option) and visualize it.'
        )
        self.op.add_option(
            '--plot',
            dest='plot',
