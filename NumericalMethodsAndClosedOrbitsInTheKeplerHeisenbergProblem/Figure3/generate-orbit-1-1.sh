...
# The 1/1 orbit
/usr/bin/time --verbose python3 -m heisenberg.plot --dt=0.003 --max-time=20.0 --embedding-dimension=1 --embedding-solution-sheet-index=0 --plot-type=pdf --initial-preimage=[3.043097949152258e-06] --output-dir="$OUTPUT_DIR" --quantities-to-plot="x,y;t,z" --use-terse-plot-titles --plot-size=3
