...
# The 1/2 orbit
/usr/bin/time python3 -m heisenberg.plot --dt=0.003 --max-time=1.679e+01 --embedding-dimension=1 --embedding-solution-sheet-index=0 --plot-type=pdf --initial-preimage=[1.64380951372436468e-01] --output-dir="$OUTPUT_DIR" --quantities-to-plot="x,y;t,z" --use-terse-plot-titles --plot-size=3
