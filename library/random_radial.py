...
def random_point_with_uniform_radial_exponent_distribution (*, shape, inner_radius, outer_radius, rng=np.random):
...
if __name__ == '__main__':
    ...
    shape = (3,)
    point_v = [random_point_with_uniform_radial_exponent_distribution(shape=shape, inner_radius=inner_radius, outer_radius=outer_radius) for _ in range(100000)]
