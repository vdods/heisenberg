...
/usr/bin/time --verbose python3 -m heisenberg.sample --dt=0.01 --max-time=100 --embedding-dimension=2 --embedding-solution-sheet-index=0 --samples-dir="$OUTPUT_DIR" --seed=54325438 --sampling-domain=[[-0.05,0.05],[0.0,0.4]] --sampling-type=ordered --sampling-range=[25,100]
